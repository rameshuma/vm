                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($clients as $key => $client)
                                                ...
                                                <td>
                                                    {{-- <form id="{{$client->client_no}}" action="{{route("clientmaster.destroy",$client->client_no)}}" method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                    </form>
                                                    <button onclick="deleteAd({{$client->client_no}})" type="submit" class="btn btn-sm btn-danger">
