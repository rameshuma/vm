       ...
       $("#cname").focusout(function()
        {
            ...
            {
                document.getElementById("cl1").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
                $('#edit_button').prop('disabled',true);
            }
        ...
        $("#companyname").focusout(function()
        {
            ...
            {
                document.getElementById("cl2").innerHTML="<span class='text-danger m-2'>Please enter valid company name</span>";
                $('#edit_button').prop('disabled',true);
            }
        });
        $("#contactnumber").focusout(function()
        {
            ...
            {
                document.getElementById("cl3").innerHTML="<span class='text-danger m-2'>Please enter valid contact number</span>";
                $('#edit_button').prop('disabled',true);
            }
