                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="card-body ">
                                        <form id="myform" method="POST" class="form-row" action="{{ route('suppliermaster.store') }}" enctype="multipart/form-data">
                                            ...
                                            {{-- <div class="form-group col-md-6">
                                                <label for="code" class="form-label fw-bold">Supplier Code<a style="text-decoration: none;color:red">*</a></label>
                                                <input type="text" name="code" value="{{old("code")}}" placeholder="Supplier Code" class="form-control" autocomplete="off" id="code">
                                                <span id="code_val" required></span>
                                            </div> --}}
                                            <div class="form-group col-md-6">
...
{{--Datatable search bar and export button code here--}}
 ...
 else if(re.test($(this).val())==true)
 {
  ...
  {
    document.getElementById("add-info-btn").disabled=true;
    document.getElementById("name_val").innerHTML="<span class='text-danger m-2'>Please enter the valid name</span>";
  }
 ...
 else if(re.test($(this).val())==true)
 {
  ...
  {
    document.getElementById("company_val").innerHTML="<span class='text-danger m-2'>Please enter valid company name</span>";
    document.getElementById("add-info-btn").disabled=true;
  }
 ...
 else if(re.test($(this).val())==true)
 {
  ...
  {
    document.getElementById("contact_number_val").innerHTML="<span class='text-danger m-2'>Please enter valid contact number</span>";
    document.getElementById("add-info-btn").disabled=true;
  }
 ...
 else if(re.test($(this).val())==true)
 {
  ...
  {
    document.getElementById("email_val").innerHTML="<span class='text-danger m-2'>Please enter valid email id</span>";
    document.getElementById("add-info-btn").disabled=true;
  }
...
{
 document.getElementById("edit-info-btn").disabled=true;
 document.getElementById("u_name_val").innerHTML="<span class='text-danger m-2'>Please enter the valid name</span>";
}
...
{
 document.getElementById("u_company_name_val").innerHTML="<span class='text-danger m-2'>Please enter valid company name</span>";
 document.getElementById("edit-info-btn").disabled=true;
}
...
{
 document.getElementById("u_contact_number_val").innerHTML="<span class='text-danger m-2'>Please enter valid contact number</span>";
 document.getElementById("edit-info-btn").disabled=true;
}
...
{
 document.getElementById("u_email_val").innerHTML="<span class='text-danger m-2'>Please enter valid email id</span>";
 document.getElementById("edit-info-btn").disabled=true;
}
