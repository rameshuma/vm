...
//    alert ($(this).attr("id"));
 ...
 $(".esite_name").focusout(function(){
    ...
    $('.update').prop('disabled',false);
            ...
            document.getElementById("esn").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
            $('.update').prop('disabled',true);
        }
 });
...
$(".esite_manager").focusout(function(){
    ...
    $('.update').prop('disabled',false);
            ...
            document.getElementById("sm").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
            $('.update').prop('disabled',true);
        }
 });
});
