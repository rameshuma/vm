                                        ...
                                        @foreach ($projects as $key => $project)
                                                ...
                                                <td>
                                                    <a href="{{route("projectmaster.edit",$project->project_no)}}"
                                                        class="btn btn-info btn-circle btn-sm mx-2 edit" data-toggle="modal" id="{{$project->project_no}}" data-target="#edit_projectmaster_{{$project->project_no}}">
                                                        <i class="fas fa-check"></i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <form method="POST" action="{{route('projectmaster.destroy',$project->client_no)}}" accept-charset="UTF-8" style="display:inline">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
...
<script>
    ...
    //         {
    //             document.getElementById("c1").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
    //             $('#add_button').prop('disabled',true);
    //         }
    //     });
    ...
    //         else if(name_reg.test($(this).val()) == false)
    //         {
    //             document.getElementById("c2").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
    //             $('#add_button').prop('disabled',true);
    //         }
    //     });
    ...
    //         {
    //             document.getElementById("c3").innerHTML="<span class='text-danger m-2'>Please enter valid contact number</span>";
    //             $('#add_button').prop('disabled',true);
    //         }
    //     });
