...
<script>
 ...
 $("#item_name").focusout(function(){
    ...
    $('#add_button').prop('disabled',false);
            ...
            document.getElementById("s1").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
            $('#add_button').prop('disabled',true);
        }
 });
...
$("#supplier_name").focusout(function(){
    ...
    $('#add_button').prop('disabled',false);
            ...
            document.getElementById("s5").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
            $('#add_button').prop('disabled',true);
        }
 });
...
//  autoComplete("widget").insertAfter(dlgc.parent());
//  });
// }
