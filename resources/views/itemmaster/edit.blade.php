...
//    alert ($(this).attr("id"));
   $.ajax({
    ...
    success: function(data) {
        ...
        // console.log(data[0].item_category);
        // console.log(data[0].stock_type);
        // console.log(data[0].item_type);
        // console.log(data[0].supplier_name);
        // console.log(data[0].supplier_code);
...
// alert($(this).val());
    ...
    document.getElementById("i0").innerHTML="";
     $('#edit_button').prop('disabled',false);
            ...
            document.getElementById("i0").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
             $('#edit_button').prop('disabled',true);
        }
 });
...
document.getElementById("i4").innerHTML="";
 $('#edit_button').prop('disabled',false);
        ...
        document.getElementById("i4").innerHTML="<span class='text-danger m-2'>Name should not contain special characters & numbers</span>";
...
// if((name_reg.test($('.itemname').val()) == false ) && (name_reg.test($('.suppliername').val()) == false)){
    // $('#edit_button').prop('disabled',true);
// }
 });
...
<script>
    $("#create").hide();
        var autocomplete,
      dlg1 = $("#edit");
    //  S.fn.init [div#edit.modal.fade.show]
